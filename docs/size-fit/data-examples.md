...
> **Note**: Gender is obtained from `product.metafields.features.gender.value[0].name` (should be "men")
...
> **Note**: Gender is obtained from `product.metafields.features.gender.value[0].name` (should be "women")
...
> **Note**: Product category is obtained from `product.metafields.features.kind.value[0].name` (should be "top")
...
> **Note**: Product category is obtained from `product.metafields.features.kind.value[0].name` (should be "bottom")
